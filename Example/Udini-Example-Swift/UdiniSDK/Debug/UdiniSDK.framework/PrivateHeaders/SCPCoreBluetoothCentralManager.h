...
@property (nonatomic, copy) void (^startUpFailureBlock)(CBManagerState CBManagerState);
...
- (void)setStartUpFailureBlock:(void (^)(CBManagerState CBManagerState))startUpFailureBlock;
